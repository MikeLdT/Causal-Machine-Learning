...
```{r}
# Estimamos el CATE para el causal forest usando predict
cate_causal_forest <- predict(forest, estimate.variance = TRUE)
...
cate_causal_forest %>% 
  ...
  scale_color_manual(name = "Estadisticos", values = c("red")) +
  theme_minimal()
